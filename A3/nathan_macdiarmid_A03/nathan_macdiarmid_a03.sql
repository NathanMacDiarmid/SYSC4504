...
--
-- Host: localhost
-- Generation Time: Apr 10, 2024 at 02:59 AM
...
CREATE DATABASE IF NOT EXISTS nathan_macdiarmid_syscx;
USE nathan_macdiarmid_syscx;
...
--
-- Database: `nathan_macdiarmid_syscx`
--
...
--
ALTER TABLE `users_info`
  MODIFY `student_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;
