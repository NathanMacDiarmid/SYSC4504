...
CREATE DATABASE IF NOT EXISTS nathan_macdiarmid_syscbook;
USE nathan_macdiarmid_syscbook;
...
--
ALTER TABLE `users_info`
  MODIFY `student_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
